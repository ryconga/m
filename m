...
for _, gui in pairs(game:GetService("CoreGui"):GetChildren()) do
    if gui.Name == "KimchiUI" or gui.Name == "KimchiShadow" or gui.Name == "KimchiNotifications" then
        gui:Destroy()
    end
end
...
local Themes = {
    ["Dark"] = {
        ...
        ToggleOuterEnabled = Color3.fromRGB(80, 201, 206),
        ToggleOuterUIStroke = Color3.fromRGB(54, 54, 62),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(80, 201, 206),
        ToggleInner = Color3.fromRGB(66, 66, 76),
        ToggleInnerEnabled = Color3.fromRGB(255, 255, 255),
        ContainerHolder = Color3.fromRGB(26, 26, 31),
        HighlightUIStroke = Color3.fromRGB(80, 201, 206),
        Highlight = Color3.fromRGB(80, 201, 206),
        SettingsPanel = Color3.fromRGB(25, 25, 30),
        SettingsFrame = Color3.fromRGB(30, 30, 35),
        ToggleTextEnabled = Color3.fromRGB(80, 201, 206)
    },
    ["Tokyo Night"] = {
        ...
        ToggleOuterEnabled = Color3.fromRGB(255, 183, 38),
        ...
        HighlightUIStroke = Color3.fromRGB(255, 183, 38),
        Highlight = Color3.fromRGB(255, 183, 38),
        SettingsPanel = Color3.fromRGB(31, 32, 45),
        SettingsFrame = Color3.fromRGB(39, 40, 57),
        ToggleTextEnabled = Color3.fromRGB(255, 183, 38)
    },
    ["Starry Night"] = {
        ...
        ToggleOuterEnabled = Color3.fromRGB(255, 211, 105),
        ...
        HighlightUIStroke = Color3.fromRGB(255, 211, 105),
        Highlight = Color3.fromRGB(255, 211, 105),
        SettingsPanel = Color3.fromRGB(19, 23, 30),
        SettingsFrame = Color3.fromRGB(23, 27, 35),
        ToggleTextEnabled = Color3.fromRGB(255, 211, 105)
    }
}
...
function library:SaveConfig(name)
    ...
    for flag, value in pairs(library.Flags) do
        if typeof(value) == "EnumItem" then
            config.Flags[flag] = {Type = "Enum", Value = tostring(value)}
        else
            config.Flags[flag] = value
        end
    end
    writefile("KimchiUI/Configs/" .. name .. ".json", HttpService:JSONEncode(config))
end

function library:LoadConfig(name)
    if not name or name == "" then return end
    local path = "KimchiUI/Configs/" .. name .. ".json"
...
function library:GetConfigs()
    local configs = {}
    if isfolder("KimchiUI/Configs") then
        for _, file in ipairs(listfiles("KimchiUI/Configs")) do
...
function library:Window(Info)
    ...
    mainShadow.Image = getcustomasset("KimchiUI/Shadow.png")
    ...
    mainShadow.Size = UDim2.new(0, 700, 0, 370)
    ...
    main.Size = UDim2.new(0, 680, 0, 350)
    main.Parent = unnamed
    ...
    topbar.Size = UDim2.new(0, 680, 0, 34)
    topbar.Parent = main
    ...
    topbarLine.Size = UDim2.new(0, 680, 0, 1)
    topbarLine.ZIndex = 2
    ...
    windowName.Size = UDim2.new(0, 598, 0, 34)
    ...
    closeButton.Position = UDim2.new(0.968, 3, 0.235, 0)
    ...
    minimizeButton.Position = UDim2.new(0.968, -18, 0.235, 0)
    ...
    minimizeButton.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(main, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Size = Minimized and UDim2.new(0, 680, 0, 34) or UDim2.new(0, 680, 0, 350)}):Play()
    ...
    uIPaddingTabs.Name = "UIPadding"
    uIPaddingTabs.PaddingBottom = UDim.new(1, 0)
    uIPaddingTabs.PaddingLeft = UDim.new(0, 6)
    uIPaddingTabs.Parent = tabContainerScrolling
    
    local contentContainer = Instance.new("Frame")
    contentContainer.Name = "ContentContainer"
    contentContainer.BackgroundColor3 = Theme.Main
    contentContainer.BorderSizePixel = 0
    contentContainer.Position = UDim2.new(0, 131, 0.0971, 0)
    contentContainer.Size = UDim2.new(0, 368, 0, 316)
    contentContainer.Parent = main
    
    local contentContainerLine = Instance.new("Frame")
    contentContainerLine.Name = "ContentContainerLine"
    contentContainerLine.AnchorPoint = Vector2.new(1, 0)
    contentContainerLine.BackgroundColor3 = Theme.Lines
    contentContainerLine.BorderSizePixel = 0
    contentContainerLine.Position = UDim2.new(1, 0, 0, 0)
    contentContainerLine.Size = UDim2.new(0, 1, 0, 316)
    contentContainerLine.ZIndex = 2
    contentContainerLine.Parent = contentContainer
    ...
    containers.Position = UDim2.new(0, 0, 0, 0)
    containers.Selectable = false
    containers.Size = UDim2.new(0, 368, 0, 316)
    containers.Parent = contentContainer
    
    local settingsPanel = Instance.new("Frame")
    settingsPanel.Name = "SettingsPanel"
    settingsPanel.BackgroundColor3 = Theme.SettingsPanel
    settingsPanel.BorderSizePixel = 0
    settingsPanel.Position = UDim2.new(0, 499, 0.0971, 0)
    settingsPanel.Size = UDim2.new(0, 181, 0, 316)
    ...
    settingsScrolling.CanvasSize = UDim2.new()
    settingsScrolling.ScrollBarThickness = 0
    settingsScrolling.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    settingsScrolling.BackgroundTransparency = 1
    settingsScrolling.BorderSizePixel = 0
    settingsScrolling.Position = UDim2.new(0, 0, 0, 6)
    settingsScrolling.Size = UDim2.new(0, 181, 0, 304)
    settingsScrolling.Parent = settingsPanel
    
    local settingsListLayout = Instance.new("UIListLayout")
    settingsListLayout.Name = "UIListLayout"
    settingsListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    settingsListLayout.Parent = settingsScrolling
    
    local settingsPadding = Instance.new("UIPadding")
    settingsPadding.Name = "UIPadding"
    settingsPadding.PaddingLeft = UDim.new(0, 6)
    settingsPadding.PaddingTop = UDim.new(0, 1)
    ...
    function window:Tab(Info)
        ...
        function tabtable:Section(Info)
            ...
            sectionIcon.Image = getcustomasset("KimchiUI/Chevron.png")
            ...
            function sectiontable:Slider(Info)
                ...
                dragIcon.Image = getcustomasset("KimchiUI/Circle.png")
            ...
            function sectiontable:Dropdown(Info)
                ...
                dropdownIcon.Image = getcustomasset("KimchiUI/Chevron.png")
                ...
                function insidedropdown:Add(str)
                    ...
                    dropdownElementButton.MouseButton1Click:Connect(function()
                        ...
                        TweenService:Create(section, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 175, 0, section.Size.Y.Offset - DropdownY)}):Play()
                        TweenService:Create(sectionFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset - DropdownY)}):Play()
                        TweenService:Create(itemContainer, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset - DropdownY)}):Play()
                        TweenService:Create(dropdown, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 175, 0, 28)}):Play()
                        TweenService:Create(dropdownFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 171, 0, 24)}):Play()
                        TweenService:Create(dropdownContainer, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 171, 0, 0)}):Play()
                        TweenService:Create(dropdownIcon, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Rotation = 90}):Play()
                        dropdownIcon.Position = UDim2.new(0, 155, 0, 5)
                        task.wait(.1)
                        containerHolder.ClipsDescendants = true
                    end)
                ...
                SectionOpened:GetPropertyChangedSignal("Value"):Connect(function()
                    ...
                    dropdownFrame.Size = UDim2.new(0, 171, 0, 24)
                    dropdownContainer.Size = UDim2.new(0, 171, 0, 0)
                    section.Size = UDim2.new(0, 175, 0, section.Size.Y.Offset - DropdownY)
                    sectionFrame.Size = UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset - DropdownY)
                    itemContainer.Size = UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset - DropdownY)
                    dropdownIcon.Rotation = 90
                    dropdownIcon.Position = UDim2.new(0, 155, 0, 5)
                    task.wait(.1)
                    containerHolder.ClipsDescendants = true
            ...
            function sectiontable:Toggle(Info)
                ...
                toggleText.TextColor3 = Info.Default and Theme.ToggleTextEnabled or Theme.ItemText
                ...
                toggleOuter.BackgroundColor3 = Info.Default and Theme.ToggleOuterEnabled or Theme.ToggleOuter
                ...
                toggleOuterUIStroke.Color = Info.Default and Theme.ToggleOuterUIStrokeEnabled or Theme.ToggleOuterUIStroke
                ...
                toggleInner.Image = getcustomasset("KimchiUI/Circle.png")
                toggleInner.ImageColor3 = Info.Default and Theme.ToggleInnerEnabled or Theme.ToggleInner
                toggleInner.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                toggleInner.BackgroundTransparency = 1
                toggleInner.BorderSizePixel = 0
                toggleInner.Position = Info.Default and UDim2.new(0, 18, 0, 2) or UDim2.new(0, 2, 0, 2)
                ...
                function toggletable:Set(bool)
                    ...
                    TweenService:Create(toggleText, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {TextColor3 = bool and Theme.ToggleTextEnabled or Theme.ItemText}):Play()
                ...
                table.insert(toggleCallbacks, toggletable)
    ...
    function window:SettingsSection(Info)
        Info.Text = Info.Text or "Settings"
        ...
        settingsSection.Size = UDim2.new(0, 169, 0, 33)
        settingsSection.Parent = settingsScrolling
        
        local settingsFrame = Instance.new("Frame")
        settingsFrame.Name = "SettingsFrame"
        settingsFrame.BackgroundColor3 = Theme.SettingsFrame
        settingsFrame.BorderSizePixel = 0
        settingsFrame.Size = UDim2.new(0, 169, 0, 28)
        settingsFrame.Parent = settingsSection
        
        local settingsUICorner = Instance.new("UICorner")
        settingsUICorner.CornerRadius = UDim.new(0, 2)
        ...
        settingsName.Text = Info.Text
        settingsName.TextColor3 = Theme.SectionText
        ...
        settingsName.Position = UDim2.new(0.0343, 0, 0, 0)
        settingsName.Size = UDim2.new(0, 163, 0, 28)
        settingsName.Parent = settingsFrame
        
        local settingsUIStroke = Instance.new("UIStroke")
        settingsUIStroke.Color = Theme.SectionUIStroke
        settingsUIStroke.Parent = settingsFrame
        
        local itemContainer = Instance.new("Frame")
        itemContainer.Name = "ItemContainer"
        itemContainer.BackgroundColor3 = Theme.ContainerHolder
        itemContainer.BorderSizePixel = 0
        itemContainer.Position = UDim2.new(0, 0, 0, 28)
        itemContainer.Size = UDim2.new(0, 169, 0, 0)
        itemContainer.Parent = settingsSection
        ...
        function settingstable:Button(Info)
            Info.Text = Info.Text or "Button"
            Info.Callback = Info.Callback or function() end
            ...
            button.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            button.BackgroundTransparency = 1
            button.Size = UDim2.new(0, 169, 0, 28)
            button.Parent = itemContainer
            ...
            buttonFrame.BorderSizePixel = 0
            buttonFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
            buttonFrame.Size = UDim2.new(0, 165, 0, 24)
            buttonFrame.Parent = button
            ...
            buttonText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            buttonText.BackgroundTransparency = 1
            buttonText.Size = UDim2.new(0, 165, 0, 24)
            buttonText.Parent = buttonFrame
            ...
            buttonTextButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            buttonTextButton.BackgroundTransparency = 1
            buttonTextButton.Size = UDim2.new(0, 165, 0, 24)
            buttonTextButton.Parent = buttonFrame
            ...
            settingsSection.Size = UDim2.new(0, 169, 0, settingsSection.Size.Y.Offset + 28)
            itemContainer.Size = UDim2.new(0, 169, 0, itemContainer.Size.Y.Offset + 28)
        end
        
        function settingstable:Toggle(Info)
            Info.Text = Info.Text or "Toggle"
            Info.Default = Info.Default or false
            Info.Flag = Info.Flag or nil
            Info.Callback = Info.Callback or function() end
            ...
            toggle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            toggle.BackgroundTransparency = 1
            toggle.Size = UDim2.new(0, 169, 0, 28)
            toggle.Parent = itemContainer
            ...
            toggleFrame.BorderSizePixel = 0
            toggleFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
            toggleFrame.Size = UDim2.new(0, 165, 0, 24)
            toggleFrame.Parent = toggle
            ...
            toggleText.BackgroundTransparency = 1
            toggleText.Position = UDim2.new(0.0234, 0, 0, 0)
            toggleText.Size = UDim2.new(0, 161, 0, 24)
            toggleText.Parent = toggleFrame
            ...
            toggleTextButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            toggleTextButton.BackgroundTransparency = 1
            toggleTextButton.Size = UDim2.new(0, 165, 0, 24)
            toggleTextButton.Parent = toggleFrame
            ...
            toggleOuter.Name = "ToggleOuter"
            toggleOuter.BackgroundColor3 = Info.Default and Theme.ToggleOuterEnabled or Theme.ToggleOuter
            toggleOuter.Position = UDim2.new(-0.023, 133, 0.167, 1)
            toggleOuter.Size = UDim2.new(0, 30, 0, 14)
            toggleOuter.Parent = toggleFrame
        ...
        function settingstable:Input(Info)
            Info.Text = Info.Text or "Input"
            Info.Flag = Info.Flag or nil
            Info.Callback = Info.Callback or function() end
            ...
            input.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            input.BackgroundTransparency = 1
            input.Size = UDim2.new(0, 169, 0, 28)
            input.Parent = itemContainer
            ...
            inputFrame.ClipsDescendants = true
            inputFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
            inputFrame.Size = UDim2.new(0, 165, 0, 24)
            inputFrame.Parent = input
            ...
            textBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            textBox.BackgroundTransparency = 1
            textBox.Size = UDim2.new(0, 165, 0, 24)
            textBox.Parent = inputFrame
        ...
        function settingstable:Dropdown(Info)
            Info.Text = Info.Text or "Dropdown"
            Info.Flag = Info.Flag or nil
            Info.Default = Info.Default or nil
            Info.List = Info.List or {}
            ...
            dropdown.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            dropdown.BackgroundTransparency = 1
            dropdown.Size = UDim2.new(0, 169, 0, 28)
            dropdown.Parent = itemContainer
            ...
            dropdownFrame.BorderSizePixel = 0
            dropdownFrame.Position = UDim2.new(0, 2, 0, 2)
            dropdownFrame.Size = UDim2.new(0, 165, 0, 24)
            dropdownFrame.Parent = dropdown
            ...
            dropdownText.BackgroundTransparency = 1
            dropdownText.Position = UDim2.new(0.0234, 0, 0, 0)
            dropdownText.Size = UDim2.new(0, 161, 0, 24)
            dropdownText.Parent = dropdownFrame
            ...
            dropdownTextButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            dropdownTextButton.BackgroundTransparency = 1
            dropdownTextButton.Size = UDim2.new(0, 165, 0, 24)
            dropdownTextButton.Parent = dropdownFrame
            ...
            dropdownIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            dropdownIcon.BackgroundTransparency = 1
            dropdownIcon.Position = UDim2.new(0, 149, 0, 5)
            dropdownIcon.Rotation = 90
            dropdownIcon.Size = UDim2.new(0, 17, 0, 17)
            dropdownIcon.ZIndex = 2
            dropdownIcon.Parent = dropdown
            ...
            dropdownContainer.ClipsDescendants = true
            dropdownContainer.Position = UDim2.new(0, 2, 0, 24)
            dropdownContainer.Size = UDim2.new(0, 165, 0, 0)
            dropdownContainer.Parent = dropdown
            ...
            function insidedropdown:Add(str)
                ...
                dropdownElement.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                dropdownElement.BackgroundTransparency = 1
                dropdownElement.Size = UDim2.new(0, 165, 0, 24)
                dropdownElement.ZIndex = 2
                dropdownElement.Parent = dropdownContainer
                ...
                dropdownElementText.BackgroundTransparency = 1
                dropdownElementText.Position = UDim2.new(0.0234, 0, 0, 0)
                dropdownElementText.Size = UDim2.new(0, 161, 0, 24)
                dropdownElementText.Parent = dropdownElement
                ...
                dropdownElementButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                dropdownElementButton.BackgroundTransparency = 1
                dropdownElementButton.Size = UDim2.new(0, 165, 0, 24)
                dropdownElementButton.Parent = dropdownElement
                ...
                dropdownElementButton.MouseButton1Click:Connect(function()
                    ...
                    settingsSection.Size = UDim2.new(0, 169, 0, settingsSection.Size.Y.Offset - DropdownY)
                    itemContainer.Size = UDim2.new(0, 169, 0, itemContainer.Size.Y.Offset - DropdownY)
                end)
            end
            ...
            dropdownTextButton.MouseButton1Click:Connect(function()
                ...
                dropdown.Size = DropdownOpened and UDim2.new(0, 169, 0, DropdownY + 28) or UDim2.new(0, 169, 0, 28)
                dropdownFrame.Size = DropdownOpened and UDim2.new(0, 165, 0, DropdownY + 24) or UDim2.new(0, 165, 0, 24)
                dropdownContainer.Size = DropdownOpened and UDim2.new(0, 165, 0, DropdownY) or UDim2.new(0, 165, 0, 0)
